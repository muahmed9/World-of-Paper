    ...
    <div className="min-h-screen flex flex-col md:flex-row gap-8 p-4 md:p-8 max-w-7xl mx-auto" dir="rtl">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-3">
              {invoice.items.map((item, index) => (
                <div key={item.id} className="flex flex-wrap sm:flex-nowrap gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100 group">
      ...
      <div className="w-full md:w-1/2">
        <div className="bg-white rounded-none md:rounded-2xl shadow-none md:shadow-xl border-none md:border border-slate-200 overflow-hidden sticky top-8">
          <div id="invoice-preview" className="p-8 md:p-12 flex flex-col min-h-[29.7cm] bg-white">
            <div className="flex-grow space-y-8">
              {/* Header */}
              <div className="flex flex-col items-center text-center space-y-4 border-b-2 border-slate-900 pb-8">
                <div className="w-32 h-32 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg overflow-hidden">
                  {/* Roll of paper icon representing the logo */}
              ...
              <div className="grid grid-cols-2 gap-8 py-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="text-slate-400 font-bold text-xs uppercase tracking-widest">إلى السيد/ة:</span>
                    <span className="text-slate-900 font-bold border-b border-slate-200 flex-1 pb-1">
                      {invoice.customerName || '................................'}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-slate-400 font-bold text-xs uppercase tracking-widest">رقم الهاتف:</span>
                ...
                <div className="space-y-3 text-right">
                  <div className="flex items-center justify-start gap-3">
                    <span className="text-slate-400 font-bold text-xs uppercase tracking-widest">رقم القائمة:</span>
                    <span className="text-slate-900 font-bold">{invoice.invoiceNumber}</span>
                  </div>
                  <div className="flex items-center justify-start gap-3">
                    <span className="text-slate-400 font-bold text-xs uppercase tracking-widest">التاريخ:</span>
            ...
            <div className="space-y-8">
              ...
              <div className="pt-8 text-center">
                <p className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em]">
                  تم التوليد بواسطة نظام عالم ورق الكاشير الذكي
                </p>
              </div>
            </div>
